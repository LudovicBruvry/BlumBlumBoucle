...
function findCircleLinePointsIntersections(r, h, k, pointA, pointB) {
  const im = (pointA.y - pointB.y) / (pointA.x - pointB.x);
  const m = -1 / im;
...
export { getDistance, findCircleLineIntersections, intersects, getOrbitAngle, findCircleLinePointsIntersections, findLinesIntersection, getArrayMin, splitPointsIntoLines, getMediumPoint, getCorrectLineBetween2Lines };
